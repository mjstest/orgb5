...
@borg.on(admin_cmd(pattern="webupload ?(.+?|) --(anonfiles|transfer|filebin|anonymousfiles|megaupload|bayfiles|github)"))
async def _(event):
	...
	CMD_WEB = {
        ...
        "github": "curl -F \"file=@{full_file_path}\" https://morejust.herokuapp.com/file"
	}
